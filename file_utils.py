...
def read_target_embeddings(target_ids, embeddings_in):
    """
    Read embeddings from h5 file generated by bio_embeddings pipeline
    :param embeddings_in:
    :return:
    """
    target_ids_array = np.load(target_ids)
    embeddings_array = np.load(embeddings_in)
    embeddings_dict = dict(zip(target_ids_array, embeddings_array))
